...
define manila::backend::service_instance (
  ...
  String[1] $service_image_name                                = 'manila-service-image',
  Glance::ImageContainerFormat $service_image_container_format = 'bare',
  Glance::ImageDiskFormat $service_image_disk_format           = 'qcow2',
